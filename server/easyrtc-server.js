...
//   console.log("New connection! " + socket.id+ " " + easyrtcid);
// });


easyrtc.events.on("easyrtcMsg", function(connectionObj, msg, socketCallback, next){
  console.log("I see you." + msg.msgType + " " + msg.msgData + " "+ connectionObj.getEasyrtcid());

  connectionObj.socket.emit("my_data", "Hello from server.");
